        ...
        <DialogHeader className="mb-8">
          ...
          >
            ...
            <DialogDescription className="text-[#FAF3E0]/60 text-base">
              ...
              {selectedPlanName && <span className="text-[#FFD76A] font-semibold ml-1">gói {selectedPlanName}</span>}
            </DialogDescription>
          </motion.div>
        </DialogHeader>
        ...
        <div className="space-y-5">
          ...
          >
            ...
            <div className="relative group">
              <Input
                ...
                className="bg-[#1a1a1a] border-[#FFD76A]/20 text-white h-12 rounded-xl transition-all duration-300 focus:border-[#FFD76A] focus:bg-[#1F1F1F] focus:shadow-[0_0_20px_rgba(255,215,106,0.15)] pr-12"
                placeholder="••••••••"
                disabled={isLoading}
              />
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#FFD76A]/60 hover:text-[#FFD76A] transition-colors"
                disabled={isLoading}
              >
          ...
          >
            <button
              ...
              className="text-sm text-[#FFD76A] hover:text-[#FDB931] transition-colors underline"
              disabled={isLoading}
            >
              Quên mật khẩu?
            </button>
