      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            {t('title', { defaultMessage: 'Tại sao chọn Bright4Event?' })}
          </h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            {t('subtitle', { defaultMessage: 'Chúng tôi kết hợp công nghệ hiện đại với trải nghiệm con người để tạo nên sự kiện hoàn hảo' })}
          </p>
        </motion.div>
