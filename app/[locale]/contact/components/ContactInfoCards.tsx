  ...
  const contactItems = [
    {
      ...
      info: t('info.address.content'),
    },
    {
      icon: Mail,
      color: '#6D28D9',
      title: t('info.email.title'),
      info: t('info.email.content'),
    },
    {
      icon: Phone,
      color: '#0EA5E9',
      title: t('info.phone.title'),
      info: t('info.phone.content'),
    },
  ]
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {t('info.title', { defaultMessage: 'Liên hệ với chúng tôi' })}
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {t('info.subtitle', { defaultMessage: 'Đội ngũ Bright4Event luôn sẵn sàng lắng nghe và tư vấn giải pháp phù hợp nhất' })}
          </p>
        </motion.div>
