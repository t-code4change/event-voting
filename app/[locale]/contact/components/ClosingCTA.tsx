    ...
    <section className="relative overflow-hidden pt-[100px] pb-[100px]">
      ...
      <div className="container relative px-4 z-10">
        ...
        >
          ...
          <p className="text-lg text-white/70">{t('description', { defaultMessage: 'với công nghệ hiện đại và dịch vụ tận tâm' })}</p>
            ...
            >
              <Link href="/pricing">
                <MyButton
                  variant="outline"
                  size="large"
                  className="text-lg px-10 py-7 rounded-full border border-[#FFD95A] text-[#FFD95A] hover:bg-[#FFD95A]/10 font-bold backdrop-blur-sm"
                  icon={<Sparkles className="h-6 w-6" />}
                  iconPosition="left"
                >
                  {t('explore', { defaultMessage: 'Khám phá gói dịch vụ' })}
                </MyButton>
              </Link>
            </motion.div>
            ...
            <Link href={`/event/${DEMO_EVENT_ID}`}>
              ...
              >
                <MyButton
                  variant="primary"
                  size="large"
                  className="text-lg px-10 py-7 rounded-full bg-[#FFD95A] text-[#0D0D1A] hover:bg-[#FFD95A]/90 font-bold shadow-2xl"
                  icon={<Play className="h-5 w-5" />}
                  iconPosition="left"
                >
                  {t('demo', { defaultMessage: 'Xem demo trực tiếp' })}
                </MyButton>
              </motion.div>
            </Link>
          </div>
