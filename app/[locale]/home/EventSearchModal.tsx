...
export default function EventSearchModal({ show, onClose }: EventSearchModalProps) {
  ...
  const handleJoinEvent = async () => {
    if (!eventCode.trim()) {
      alert(t('eventSearch.emptyError'))
      return
    }
              ...
              <CardContent className="p-8 md:p-12">
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    ...
                    <h2 className="text-3xl font-bold text-white mb-2">{t('eventSearch.title')}</h2>
                    <p className="text-gray-400">{t('eventSearch.subtitle')}</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <MyButton
                        ...
                        iconPosition="right"
                      >
                        {searching ? t('eventSearch.searchingText') : t('eventSearch.buttonText')}
                      </MyButton>
                  ...
                  <div className="pt-6 border-t border-[#FFD700]/20">
                    <p className="text-sm text-gray-500 text-center mb-3">{t('eventSearch.demoSuggestion.text')}</p>
                    <div className="flex flex-wrap gap-2 justify-center">
                      ...
                      >
                        {t('eventSearch.demoSuggestion.eventName')}
                      </motion.button>
                    </div>
                  </div>
                </div>
