      ...
      <div className="container px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {TESTIMONIALS.map((testimonial, index) => {
            // Map testimonial index to translation key
            const testimonialKeys = ['vinamilk', 'fpt', 'base']
                ...
                <Card className="relative overflow-hidden border-2 border-[#FFD700]/20 bg-gradient-to-br from-[#1a1a1a] to-[#0D0D1A] hover:border-[#FFD700] transition-all duration-300 group h-full">
                  ...
                  <CardContent className="p-8 space-y-4 relative z-10">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-white">{t(`items.${testimonialKey}.name`)}</h3>
                        <p className="text-sm text-gray-400">{t(`items.${testimonialKey}.role`)}</p>
                        <p className="text-xs text-[#FFD700] font-semibold">{t(`items.${testimonialKey}.company`)}</p>
                      </div>
                    </div>
