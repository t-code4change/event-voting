...
import {
  ...
  Calendar, Users, Monitor, Presentation, Gift, Gamepad2, BarChart3,
  Layers, Palette, Code, Wifi
} from "lucide-react"
...
const COLORS = {
  primary: '#FFD700',        // Gold (Design System Primary)
  secondary: '#FDB931',      // Secondary Gold
  bgDark: '#0A0A0A',         // Deep Black
  bgGradient: '#1a1a1a',     // Dark gradient (from design system)
  ...
  borderPurple: '#9C27FF',   // Purple border (Design System Purple accent)
  borderGold: '#FFD700',     // Gold border
}
...
export default function GuidePage() {
  ...
  // Icon mapping for organizer steps
  const stepIcons = [Calendar, Users, QrCode, Monitor, Presentation, Vote, Trophy, Gift, Gamepad2, BarChart3]

  // Build organizer steps data from translations
  const organizerStepsData = Object.entries(t.raw('organizerSteps.steps') as Record<string, any>).map(([key, step], index) => ({
    id: index + 1,
  ...
  const featureIcons = [Layers, Palette, Code, Gift, Wifi]

  // Build advanced features from translations
  const advancedFeatures = Object.entries(t.raw('advancedFeatures') as Record<string, any>)
  ...
  const faqs = Object.entries(t.raw('faqs') as Record<string, any>)
    .filter(([key]) => key !== 'title')
    .map(([key, faq]) => ({
      question: faq.q,
      answer: faq.a
        ...
        <div className="container px-4 md:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#FFD369] font-semibold relative z-10">{t('organizer.badge')}</span>
            </motion.div>
        ...
        <div className="container px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#9C27FF]/10 border border-[#9C27FF]/30 mb-6">
              ...
              <span className="text-[#9C27FF] font-semibold">{t('guest.badge')}</span>
            </div>

            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              {t.rich('guest.title', {
                highlight: (chunks) => <span className="text-[#9C27FF]">{chunks}</span>
              })}
            </h2>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <TimelineStep
              icon={QrCode}
              title={t('guest.steps.checkin.title')}
              description={t('guest.steps.checkin.description')}
              color="gold"
              delay={0.1}
            />
            ...
            <TimelineStep
              icon={Vote}
              title={t('guest.steps.vote.title')}
              description={t('guest.steps.vote.description')}
              color="purple"
              delay={0.2}
            />
            ...
            <TimelineStep
              icon={Trophy}
              title={t('guest.steps.results.title')}
              description={t('guest.steps.results.description')}
              color="blue"
              delay={0.3}
            />
          </div>
        ...
        <div className="container px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FFD700]/10 border border-[#FFD700]/30 mb-6">
              ...
              <span className="text-[#FFD700] font-semibold">{t('advanced.badge')}</span>
            </div>

            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              {t.rich('advanced.title', {
        ...
        <div className="container px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FFD700]/10 border border-[#FFD700]/30 mb-6">
              ...
              <span className="text-[#FFD700] font-semibold">{t('faq.badge')}</span>
            </div>
