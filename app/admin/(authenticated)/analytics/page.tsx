  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-6">
          <div className="flex items-center gap-2 mb-6">
            <Activity className="w-5 h-5 text-[#FFD700]" />
            <h2 className="text-lg font-bold text-white">Vote Timeline</h2>
          </div>
                ...
                <div key={index} className="relative">
                  <div className="flex justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isPeak && (
                        <span className="text-xs font-bold px-2 py-1 bg-[#FFD700]/10 text-[#FFD700] rounded">
                          Peak
                        </span>
                      )}
                    </div>
                  </div>
                  <div className="h-2 rounded-lg bg-white/10 overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${percentage}%` }}
                      transition={{ duration: 0.6, delay: index * 0.08 }}
                      className="h-full rounded-lg relative bg-[#FFD700]"
                      style={{
                    ...
                    >
                      {isPeak && (
                        <div
                          className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-[#FFD700]"
                          style={{
                  ...
                  <div key={index}>
                    ...
                    <div className="h-2 rounded-lg bg-white/10 overflow-hidden">
                      <motion.div
                        ...
                        className="h-full rounded-lg bg-[#FFD700]"
                        style={{ opacity: 0.8 }}
                      />
                    </div>
                  </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-bold text-white">Device Type</h2>
          </div>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-bold text-white">Voter Type</h2>
          </div>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-6">
        <div className="flex items-center gap-2 mb-4">
          <FileDown className="w-5 h-5 text-[#FFD700]" />
...
function MetricCard({ icon: Icon, label, value, change, delay }: any) {
  return (
    <motion.div
      ...
      className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-6 cursor-pointer transition-all hover:border-[#FFD700]/50"
    >
      <Icon className="w-5 h-5 text-[#FFD700] mb-4" />
...
function PerformanceItem({ label, value, unit, icon: Icon }: any) {
  return (
    <div className="rounded-xl bg-white/5 border border-white/20 p-4">
      <Icon className="w-4 h-4 text-[#FFD700] mb-3" />
      <p className="text-2xl font-bold text-white tabular-nums">
        {value}
        {unit && <span className="text-sm ml-1 text-white/60">{unit}</span>}
      </p>
