...
// Image metadata
export const alt = 'Câu hỏi thường gặp - Bright4Event FAQ'
export const size = {
  width: 1200,
  height: 630,
}
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Giải đáp thắc mắc về Bright4Event
        </div>
        ...
        >
          <div style={{
            ...
            <div style={{ color: '#FFD700', display: 'flex', fontSize: 18 }}>Chat Bubble</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 35, display: 'flex' }}>🎧</div>
            <div style={{ color: '#FFD700', display: 'flex', fontSize: 18 }}>Support</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 35, display: 'flex' }}>📚</div>
            <div style={{ color: '#FFD700', display: 'flex', fontSize: 18 }}>Knowledge</div>
          </div>
        </div>
