...
// Image metadata
export const alt = 'Chính sách bảo mật - Bright4Event'
export const size = {
  width: 1200,
  height: 630,
}
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          An toàn dữ liệu & quyền riêng tư
        </div>
        ...
        >
          <div style={{
            ...
            <div style={{ color: '#FFD700', display: 'flex', fontSize: 18 }}>Mã hóa SSL</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ color: '#FFD700', display: 'flex', fontSize: 18 }}>Bảo vệ dữ liệu</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 35, display: 'flex' }}>🔐</div>
            <div style={{ color: '#FFD700', display: 'flex', fontSize: 18 }}>Riêng tư</div>
          </div>
        </div>
